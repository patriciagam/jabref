...
- We added improved support for annotated PDFs, allowing users to keep comment copies attached while sending only the plain PDF via email. [#12946](https://github.com/JabRef/jabref/issues/12946)
